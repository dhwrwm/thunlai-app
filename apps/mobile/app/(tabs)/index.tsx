...
export default function HomeScreen() {
  ...
  return (
    ...
    >
      ...
      {/* Glossary shortcut */}
      <TouchableOpacity
        style={[styles.glossaryBtn, { backgroundColor: theme.card, borderColor: theme.border }]}
        onPress={() => router.push('/glossary')}
        activeOpacity={0.75}
      >
        <View style={styles.glossaryBtnLeft}>
          <Text style={styles.glossaryEmoji}>📖</Text>
          <View>
            <Text style={[styles.glossaryTitle, { color: theme.text }]}>Browse Glossary</Text>
            <Text style={[styles.glossarySub, { color: theme.textSecondary }]}>
              {stats.glossary.toLocaleString()} English → Bodo entries
            </Text>
          </View>
        </View>
...
const styles = StyleSheet.create({
  ...
  glossaryEmoji: { fontSize: 28 },
  glossaryTitle: { fontSize: 15, fontWeight: '600', marginBottom: 2 },
  glossarySub: { fontSize: 12 },
  chevron: { fontSize: 22 },
});
